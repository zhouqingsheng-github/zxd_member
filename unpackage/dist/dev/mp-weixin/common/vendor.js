...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"zxd_member","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
exports.setUserInfo = exports.setToken = exports.getUserInfo = exports.getToken = exports.default = exports.clearUserInfo = exports.checkLogin = exports.autoLogin = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            console.error('自动登录请求失败:', _context.t0);
            return _context.abrupt("return", false);
          case 18:
          case "end":
...
exports.whiteList = exports.setupRouteInterceptor = exports.routeInterceptor = void 0;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 30));
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ 5));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 32));
...
var whiteList = ['/pages/subPackages/user/login', '/pages/home/index', '/pages/subPackages/user/phone-login', '/pages/subPackages/home/search/index', '/pages/subPackages/home/detail', '/pages/subPackages/home/search-result/index', '/pages/subPackages/coupon/receive', '/pages/subPackages/coupon/receive-success', '/pages/subPackages/home/city-select/index', '/pages/subPackages/user/member-activate', '/pages/subPackages/agreement/*', '/pages/subPackages/home/photoAlbum', '/pages/subPackages/user/member-right', '/pages/subPackages/coupon/receiving-center', 'pages/subPackages/order/three_detail', '/pages/subPackages/richText/richText', '/pages/subPackages/richText/richText', '/pages/subPackages/questionnaire/submit', '/pages/subPackages/questionnaire/detail', '/pages/subPackages/wifi/index'];
exports.whiteList = whiteList;
var routeInterceptor = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(options) {
    var url, isInWhiteList, userInfo, _userInfo;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = options.url.split('?')[0];
            isInWhiteList = whiteList.some(function (whitePath) {
              if (whitePath.includes('*')) {
                var pattern = whitePath.replace('*', '.*');
                return new RegExp("^".concat(pattern, "$")).test(url);
              }
            ...
            return _context.abrupt("return", true);
          case 4:
            if ((0, _index.checkLogin)()) {
              _context.next = 8;
              break;
            }
            return _context.abrupt("return", false);
          case 8:
            userInfo = (0, _store.getUserInfo)();
            if (!userInfo) {
              _context.next = 14;
              break;
            }
          ...
          case 12:
            ...
            (0, _store.setUserInfo)(_userInfo);
          case 14:
            return _context.abrupt("return", true);
          case 15:
          case "end":
  ...
  return function routeInterceptor(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.routeInterceptor = routeInterceptor;
var setupRouteInterceptor = function setupRouteInterceptor() {
  var originalNavigateTo = uni.navigateTo;
  uni.navigateTo = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _context2.t0 = !options.redirectUrl;
            case 5:
              if (!_context2.t0) {
                _context2.next = 10;
                break;
            ...
            case 10:
              _context2.next = 12;
              return handleLoginExpiration(options);
            case 12:
            case "end":
  ...
  var originalRedirectTo = uni.redirectTo;
  uni.redirectTo = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.t0 = !options.redirectUrl;
            case 5:
              if (!_context3.t0) {
                _context3.next = 10;
                break;
  ...
  var originalReLaunch = uni.reLaunch;
  uni.reLaunch = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              _context4.t0 = !options.redirectUrl;
            case 5:
              if (!_context4.t0) {
                _context4.next = 10;
                break;
  ...
  var originalSwitchTab = uni.switchTab;
  uni.switchTab = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              _context5.t0 = !options.redirectUrl;
            case 5:
              if (!_context5.t0) {
                _context5.next = 10;
                break;
  ...
  var handleLoginExpiration = /*#__PURE__*/function () {
    var _ref6 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(options) {
      var _yield$uni$showModal, _yield$uni$showModal2, error, res, oldUrl, url, params, queryString, queryParams, _oldUrl, _url, _params, _queryString, _queryParams;
      return _regenerator.default.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 3:
              _yield$uni$showModal = _context6.sent;
              ...
              oldUrl = options.redirectUrl ? options.redirectUrl : options.url;
              url = oldUrl.split('?')[0];
              params = options.params || {};
              if (oldUrl.includes('?')) {
                queryString = oldUrl.split('?')[1];
              ...
              _context6.next = 14;
              return (0, _redirect.setRedirectInfo)({
                url: url,
                params: params,
                type: 'page'
              });
            ...
            case 16:
              ...
              break;
            case 18:
              _oldUrl = options.redirectUrl ? options.redirectUrl : options.url;
              _url = _oldUrl.split('?')[0];
              _params = options.params || {};
              if (_oldUrl.includes('?')) {
                _queryString = _oldUrl.split('?')[1];
                _queryParams = _queryString.split('&');
                _queryParams.forEach(function (param) {
                  var _param$split3 = param.split('='),
                    _param$split4 = (0, _slicedToArray2.default)(_param$split3, 2),
                    key = _param$split4[0],
    ...
    return function handleLoginExpiration(_x6) {
      return _ref6.apply(this, arguments);
    };
  }();
};
exports.setupRouteInterceptor = setupRouteInterceptor;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"]))
...
exports.setRedirectInfo = exports.pageBack = exports.handleRedirect = exports.getRedirectInfo = exports.clearRedirectInfo = void 0;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 30));
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ 5));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 32));
var _store = __webpack_require__(/*! ../store */ 33);
...
var REDIRECT_KEY = 'redirectInfo';

// tabbar页面列表
var TABBAR_PAGES = ['/pages/home/index', '/pages/order/index', '/pages/user/index', '/pages/coupon/index'];
 ...
 */
var setRedirectInfo = function setRedirectInfo(options) {
  var redirectInfo = {
    url: options.url,
    params: options.params || {},
 ...
 */
exports.setRedirectInfo = setRedirectInfo;
var getRedirectInfo = function getRedirectInfo() {
  try {
    var redirectInfo = uni.getStorageSync(REDIRECT_KEY);
    if (!redirectInfo) {
      return null;
    }
    ...
    // 检查是否过期（10分钟有效期）
    var now = Date.now();
    var expireTime = 10 * 60 * 1000; // 10分钟
 ...
 * 清除重定向信息
 */
exports.getRedirectInfo = getRedirectInfo;
var clearRedirectInfo = function clearRedirectInfo() {
  try {
 ...
 */
exports.clearRedirectInfo = clearRedirectInfo;
var handleRedirect = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var redirectInfo, queryString, url, isTabbarPage;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 5:
            ...
            return uni.redirectTo({
              url: "/pages/subPackages/coupon/receive?spread=".concat(redirectInfo.params.spread)
            });
          case 11:
            _context.next = 25;
            break;
          case 13:
            // 处理普通页面重定向
            queryString = Object.entries(redirectInfo.params).map(function (_ref2) {
              var _ref3 = (0, _slicedToArray2.default)(_ref2, 2),
                key = _ref3[0],
                value = _ref3[1];
              return "".concat(key, "=").concat(encodeURIComponent(value));
            }).join('&');
            url = queryString ? "".concat(redirectInfo.url, "?").concat(queryString) : redirectInfo.url; // 检查是否是tabbar页面
            isTabbarPage = ['/pages/home/index', '/pages/order/index', '/pages/coupon/index', '/pages/user/index'].some(function (page) {
...
var frontPage = '/pages/home/index';
var isLoginPage = function isLoginPage(route) {
  if (!route) return false;
  var loginPagePatterns = ['pages/subPackages/user/login', 'pages/subPackages/user/phone-login'];
  return loginPagePatterns.some(function (pattern) {
    return route.includes(pattern);
  });
};
var pageBack = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
    var pages, uniquePages, routeMap, i, page, route, prevPage, prevPageRoute, isPrevPageLogin, isLoggedIn, prevPageIndex, delta;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 9:
            ...
            uniquePages = [];
            routeMap = new Map(); // 从后往前遍历，保证保留的是最新的页面
            for (i = pages.length - 1; i >= 0; i--) {
              page = pages[i];
              route = page.route || ''; // 如果该路径还没有记录，则添加到uniquePages中
          ...
          case 15:
            return _context2.abrupt("return");
          case 16:
            prevPage = uniquePages[uniquePages.length - 2];
            if (prevPage) {
              _context2.next = 21;
              break;
            }
          ...
          case 20:
            return _context2.abrupt("return");
          case 21:
            prevPageRoute = prevPage.route || ''; // 判断上一页是否是登录页
            isPrevPageLogin = isLoginPage(prevPageRoute); // 获取登录状态
            isLoggedIn = (0, _store.checkLogin)();
          ...
          case 29:
            // 计算需要返回的步数
            prevPageIndex = pages.findIndex(function (page, index) {
              return index < pages.length - 1 && page.route === prevPageRoute;
            });
            delta = pages.length - 1 - prevPageIndex; // 否则正常返回
            uni.navigateBack({
              delta: delta
            });
          case 32:
...
uni.$u.http.setConfig(function (defaultConfig) {
  defaultConfig.baseURL = _config.default.baseUrl;
...
var env = {
  ...
  production: {
    baseUrl: 'https://zxd-hotel.xin/api',
    // 生产环境（修复：添加 /api 路径）
    env: 'production'
  }
};
...
// 导出配置
module.exports = _objectSpread({}, env["development"]);
...
exports.validateRefund = exports.uploadFiles = exports.uploadFile = exports.submitQuestionnaire = exports.searchHotels = exports.rightsList = exports.refundOrder = exports.receivingCenter = exports.receiveRedEnvelope = exports.receive = exports.placeAnOrder = exports.payRetry = exports.openAMembership = exports.notWrittenOff = exports.myRedEnvelope = exports.memberOrder = exports.lowestPriceCalendar = exports.logOutOfAccount = exports.getWifiCoupons = exports.getThirdOrderDetail = exports.getShareRecordList = exports.getShareDetail = exports.getRoomPrices = exports.getRoomInfo = exports.getRoomImages = exports.getPopupDecoration = exports.getOrderList = exports.getOrderEventTime = exports.getOrderDetail = exports.getMemberPriceConfig = exports.getHotelImages = exports.getHolidays = exports.getHistoryCheckInPerson = exports.getCutoffTime = exports.getAvailableRedEnvelopeList = exports.getAdvertisingDecoration = exports.gaodeKey = exports.fetchHotelListByPage = exports.fetchHotelList = exports.fetchHotelDetailByPoiId = exports.fetchHotelDetail = exports.exampleCouponInfo = exports.deleteOrder = exports.createShareRecord = exports.createOrder = exports.countSuccessShares = exports.claimShare = exports.chooseAndUploadImage = exports.channelRecordVisit = exports.cancelOrder = exports.canUserShare = exports.calculateThePrice = exports.activeItem = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _upload = _interopRequireDefault(__webpack_require__(/*! ./upload */ 174));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var http = uni.$u.http;
// 文件上传
var uploadFile = function uploadFile(filePath, options) {
  return _upload.default.uploadFile(filePath, options);
};
exports.uploadFile = uploadFile;
var uploadFiles = function uploadFiles(filePaths, options) {
  return _upload.default.uploadFiles(filePaths, options);
};
exports.uploadFiles = uploadFiles;
var chooseAndUploadImage = function chooseAndUploadImage(options) {
  return _upload.default.chooseAndUploadImage(options);
};

// 首页酒店列表 只查询上架的
exports.chooseAndUploadImage = chooseAndUploadImage;
var fetchHotelList = function fetchHotelList(params) {
  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return http.get('/hotel-stores/hotels/list', _objectSpread({
...
var fetchHotelListByPage = function fetchHotelListByPage(params) {
  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return http.get('/hotel-stores/hotels/list/page', _objectSpread({
    params: _objectSpread(_objectSpread({}, params), {}, {
      status: status
    })
  }, config));
...
// 酒店详细
exports.fetchHotelListByPage = fetchHotelListByPage;
var fetchHotelDetail = function fetchHotelDetail(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-stores/hotels/all/".concat(params.id), _objectSpread({
    params: _objectSpread({}, params)
  }, config));
};

// 酒店详细根据POIID
exports.fetchHotelDetail = fetchHotelDetail;
var fetchHotelDetailByPoiId = function fetchHotelDetailByPoiId(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-stores/hotels/poiId/".concat(id), _objectSpread({}, config));
};

// 购买会员
exports.fetchHotelDetailByPoiId = fetchHotelDetailByPoiId;
var openAMembership = function openAMembership(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-member/order/placeAnOrder', _objectSpread({
    params: _objectSpread({}, params)
  }, config));
};

// 查询会员订单支付情况
exports.openAMembership = openAMembership;
var memberOrder = function memberOrder(orderNo) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-member/order/info/".concat(orderNo), _objectSpread({}, config));
};

// 我的红包
exports.memberOrder = memberOrder;
var myRedEnvelope = function myRedEnvelope(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-promotion/promotion/red-packet/record/myRedEnvelope', _objectSpread({
    params: params
  }, config));
};

// 我的红包
exports.myRedEnvelope = myRedEnvelope;
var receivingCenter = function receivingCenter(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-promotion/promotion/red-packet/receiving-center', _objectSpread({
    params: params
  }, config));
};

// WiFi优惠券列表(业务场景为扫码连接Wi-Fi的红包)
exports.receivingCenter = receivingCenter;
var getWifiCoupons = function getWifiCoupons(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-promotion/promotion/red-packet/wifi/coupons', _objectSpread({
    params: params
  }, config));
};

// 查询领取券的基本信息
exports.getWifiCoupons = getWifiCoupons;
var exampleCouponInfo = function exampleCouponInfo(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-promotion/promotion/red-packet/record/".concat(id), _objectSpread({}, config));
};

// 领取好友赠送的红包
exports.exampleCouponInfo = exampleCouponInfo;
var receive = function receive(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-promotion/promotion/red-packet/record/gift/receive/".concat(id), _objectSpread({}, config));
};

// 领取红包
exports.receive = receive;
var receiveRedEnvelope = function receiveRedEnvelope(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-promotion/promotion/red-packet/record/receive/".concat(id), _objectSpread({}, config));
};

// 订单列表
exports.receiveRedEnvelope = receiveRedEnvelope;
var getOrderList = function getOrderList(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post('/hotel-order/hotel/order/user', _objectSpread(_objectSpread({}, params), config));
};
exports.getOrderList = getOrderList;
var notWrittenOff = function notWrittenOff(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post('/hotel-order/hotel/order/user/notWrittenOff', _objectSpread(_objectSpread({}, params), config));
};

// 订单详情
exports.notWrittenOff = notWrittenOff;
var getOrderDetail = function getOrderDetail(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-order/hotel/order/detail/".concat(id), _objectSpread({}, config));
};
...
var cancelOrder = function cancelOrder(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-order/hotel/order/cancel/".concat(id), {}, _objectSpread({}, config));
};

// 退款
exports.cancelOrder = cancelOrder;
var refundOrder = function refundOrder(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post("/hotel-order/refund/customer/refund/".concat(id), {}, _objectSpread({}, config));
};
...
var deleteOrder = function deleteOrder(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-order/hotel/order/userDelete/".concat(id), _objectSpread({}, config));
};
...
var createOrder = function createOrder(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post('/hotel-order/hotel/order/create', _objectSpread(_objectSpread({}, params), config));
};

// 费用计算
exports.createOrder = createOrder;
var calculateThePrice = function calculateThePrice(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post('/hotel-order/hotel/order/calculateThePrice', _objectSpread(_objectSpread({}, params), config));
};

// 房型预定下单
exports.calculateThePrice = calculateThePrice;
var placeAnOrder = function placeAnOrder(orderId, paymentMethod) {
  var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return http.get("/hotel-order/hotel/order/pay/".concat(orderId, "?paymentMethod=").concat(paymentMethod), _objectSpread({}, config));
};
// 再次支付
exports.placeAnOrder = placeAnOrder;
var payRetry = function payRetry(orderNo) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-order/hotel/order/pay/retry?orderNo=".concat(orderNo), _objectSpread({}, config));
};
// 获取房型
exports.payRetry = payRetry;
var getRoomInfo = function getRoomInfo(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-stores/hotel-rooms/".concat(id), _objectSpread({}, config));
};

// 可用红包列表
exports.getRoomInfo = getRoomInfo;
var getAvailableRedEnvelopeList = function getAvailableRedEnvelopeList(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post('/hotel-order/hotel/order/redPackets/available', _objectSpread(_objectSpread({}, params), config));
};

// 酒店图片列表
exports.getAvailableRedEnvelopeList = getAvailableRedEnvelopeList;
var getHotelImages = function getHotelImages(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-stores/hotel-images/hotel/".concat(id), _objectSpread({}, config));
};

// 酒店房型图片列表
exports.getHotelImages = getHotelImages;
var getRoomImages = function getRoomImages(id) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-stores/hotel-room-images/room/".concat(id), _objectSpread({}, config));
};

// 酒店地址搜索
exports.getRoomImages = getRoomImages;
var searchHotels = function searchHotels(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-stores/hotels/search/location', _objectSpread({
    params: params
  }, config));
};
...
var getRoomPrices = function getRoomPrices(params, roomId) {
  var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return http.get("/hotel-stores/hotel-room-prices//room/".concat(roomId), _objectSpread({
    params: params
  }, config));
};
...
var logOutOfAccount = function logOutOfAccount() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.delete('/hotel-member/member/logout', _objectSpread({}, config));
};

// 会员权益
exports.logOutOfAccount = logOutOfAccount;
var rightsList = function rightsList() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-member/member/rights/list', _objectSpread({}, config));
};

// 获取节假日
exports.rightsList = rightsList;
var getHolidays = function getHolidays(yearMonths) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-stores/hotels/holidays', _objectSpread({
    params: {
...
var getMemberPriceConfig = function getMemberPriceConfig() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-member/member/price/config', _objectSpread({}, config));
};

// 创建分享记录
exports.getMemberPriceConfig = getMemberPriceConfig;
var createShareRecord = function createShareRecord() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.post('/hotel-member/share/create', _objectSpread({}, config));
};

// 领取分享
exports.createShareRecord = createShareRecord;
var claimShare = function claimShare(recordId) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post("/hotel-member/share/claim/".concat(recordId), _objectSpread({}, config));
};

// 查询用户分享记录列表
exports.claimShare = claimShare;
var getShareRecordList = function getShareRecordList() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-member/share/list', _objectSpread({}, config));
};

// 查询用户是否还能分享
exports.getShareRecordList = getShareRecordList;
var canUserShare = function canUserShare() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-member/share/canShare', _objectSpread({}, config));
};

// 统计用户成功分享次数
exports.canUserShare = canUserShare;
var countSuccessShares = function countSuccessShares() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-member/share/count', _objectSpread({}, config));
};

// 获取分享明细
exports.countSuccessShares = countSuccessShares;
var getShareDetail = function getShareDetail(recordId) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-member/share/detail/".concat(recordId), _objectSpread({}, config));
};

// C端我的页面菜单项
exports.getShareDetail = getShareDetail;
var activeItem = function activeItem(recordId) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-system/system/menuitem/active', _objectSpread({}, config));
};

// 获取订单事件时间信息
exports.activeItem = activeItem;
var getOrderEventTime = function getOrderEventTime(orderId) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-order/order/events/order/".concat(orderId), _objectSpread({}, config));
};

// 退款申请前校验
exports.getOrderEventTime = getOrderEventTime;
var validateRefund = function validateRefund(orderId) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post("/hotel-order/refund/customer/refund/validate/".concat(orderId), _objectSpread({}, config));
};

// 获取酒店价格日历
exports.validateRefund = validateRefund;
var lowestPriceCalendar = function lowestPriceCalendar(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-stores/hotels/getLowestPriceCalendar', _objectSpread({
    params: _objectSpread({}, params)
  }, config));
};

// 广告装修
exports.lowestPriceCalendar = lowestPriceCalendar;
var getAdvertisingDecoration = function getAdvertisingDecoration() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-system/adcolumn/list', _objectSpread(_objectSpread({}, config), {}, {
    params: {
      status: 0
    }
  }));
...
// 弹窗装修
exports.getAdvertisingDecoration = getAdvertisingDecoration;
var getPopupDecoration = function getPopupDecoration() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-system/popup-ad/active-list', {});
};

// 高德key
exports.getPopupDecoration = getPopupDecoration;
var gaodeKey = function gaodeKey() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return http.get('/hotel-system/config/amap/get');
};

// 获取历史入住人信息
exports.gaodeKey = gaodeKey;
var getHistoryCheckInPerson = function getHistoryCheckInPerson(orderId) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-order/hotel/order/getUserInfo', _objectSpread(_objectSpread({}, config), {}, {
    params: {
      orderId: orderId
    }
  }));
...
// 记录访问量
exports.getHistoryCheckInPerson = getHistoryCheckInPerson;
var channelRecordVisit = function channelRecordVisit(id, params) {
  var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return http.get("/hotel-member/channel/visit/".concat(id), _objectSpread(_objectSpread({}, config), {}, {
    params: _objectSpread({}, params)
  }));
};

// 获取第三方订单详细
exports.channelRecordVisit = channelRecordVisit;
var getThirdOrderDetail = function getThirdOrderDetail(orderNo) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get("/hotel-order/thirdPartyOrder/detail?orderNo=".concat(orderNo), _objectSpread({}, config));
};

// 获取凌晨时间
exports.getThirdOrderDetail = getThirdOrderDetail;
var getCutoffTime = function getCutoffTime(orderNo) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.get('/hotel-stores/hotels/cutoffTime');
};

// 提交问卷
exports.getCutoffTime = getCutoffTime;
var submitQuestionnaire = function submitQuestionnaire(params) {
  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return http.post('/hotel-system/questionnaire/submit', _objectSpread(_objectSpread({}, params), config));
};
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _config = _interopRequireDefault(__webpack_require__(/*! ./config */ 164));
var _excluded = ["count", "sizeType", "sourceType"],
  _excluded2 = ["sourceType", "maxDuration"];
/**
 * 统一的文件上传工具
  ...
  (0, _createClass2.default)(Upload, [{
    ...
    value: function uploadFile(filePath) {
      ...
      var _options$url = options.url,
        url = _options$url === void 0 ? '/hotel-file/upload' : _options$url,
      ...
      return new Promise(function (resolve, reject) {
        var uploadUrl = _this.baseUrl + url;
        var token = uni.getStorageSync('token');
        console.log('开始上传文件:', {
          uploadUrl: uploadUrl,
          filePath: filePath,
    ...
    key: "uploadFiles",
    value: function uploadFiles(filePaths) {
      var _this2 = this;
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var uploadPromises = filePaths.map(function (filePath) {
        return _this2.uploadFile(filePath, options);
      });
    ...
    key: "chooseAndUploadImage",
    value: function chooseAndUploadImage() {
      var _this3 = this;
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var _options$count = options.count,
        count = _options$count === void 0 ? 9 : _options$count,
        _options$sizeType = options.sizeType,
        sizeType = _options$sizeType === void 0 ? ['compressed'] : _options$sizeType,
        _options$sourceType = options.sourceType,
        sourceType = _options$sourceType === void 0 ? ['album', 'camera'] : _options$sourceType,
        uploadOptions = (0, _objectWithoutProperties2.default)(options, _excluded);
      return new Promise(function (resolve, reject) {
        uni.chooseImage({
          count: count,
          sizeType: sizeType,
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return _this3.uploadFiles(res.tempFilePaths, uploadOptions);
                    case 3:
                      urls = _context.sent;
                      resolve(urls);
                      _context.next = 10;
    ...
    key: "chooseAndUploadVideo",
    value: function chooseAndUploadVideo() {
      var _this4 = this;
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var _options$sourceType2 = options.sourceType,
        sourceType = _options$sourceType2 === void 0 ? ['album', 'camera'] : _options$sourceType2,
        _options$maxDuration = options.maxDuration,
        maxDuration = _options$maxDuration === void 0 ? 60 : _options$maxDuration,
        uploadOptions = (0, _objectWithoutProperties2.default)(options, _excluded2);
      return new Promise(function (resolve, reject) {
        uni.chooseVideo({
          sourceType: sourceType,
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.prev = 0;
                      _context2.next = 3;
                      return _this4.uploadFile(res.tempFilePath, uploadOptions);
                    case 3:
                      url = _context2.sent;
                      resolve(url);
                      _context2.next = 10;
...
var doGetLocation = function doGetLocation(resolve, reject) {
  uni.getLocation({
    type: 'gcj02',
    isHighAccuracy: true,
    success: function () {
...
exports.isLoggedIn = exports.handleLoginRequired = void 0;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 30));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 32));
var _index = __webpack_require__(/*! @/store/index.js */ 33);
var _redirect = __webpack_require__(/*! ./redirect.js */ 35);
/**
 * 检查用户是否已登录
 * @returns {boolean} 是否已登录
 */
var isLoggedIn = function isLoggedIn() {
  return !!(0, _index.getToken)();
};
...
var handleLoginRequired = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(options) {
    var isValid;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
  ...
  return function handleLoginRequired(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.handleLoginRequired = handleLoginRequired;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"]))
